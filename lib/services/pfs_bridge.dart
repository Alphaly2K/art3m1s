...
typedef PfsOpenWithEncodingNative =
    Pointer<Void> Function(Pointer<Utf8> path, Pointer<Utf8> encoding);
typedef PfsFileSizeNative =
    Int32 Function(Pointer<Void> archive, Pointer<Utf8> path);
typedef PfsEntryCountNative = Int32 Function(Pointer<Void> archive);
typedef PfsEntryPathNative =
    Int32 Function(
...
typedef PfsUnpackNative =
    Int32 Function(Pointer<Utf8> archivePath, Pointer<Utf8> outputDir);
...
class PfsBridge {
  ...
  Pointer<Void> open(String archivePath) {
    final fn = lib
        .lookupFunction<PfsOpenNative, Pointer<Void> Function(Pointer<Utf8>)>(
          'pfs_open',
        );
  ...
  Pointer<Void> openWithEncoding(String archivePath, String encoding) {
    final fn = lib
        .lookupFunction<
          PfsOpenWithEncodingNative,
          Pointer<Void> Function(Pointer<Utf8>, Pointer<Utf8>)
        >('pfs_open_with_encoding');
    final pathPtr = archivePath.toNativeUtf8();
    final encodingPtr = encoding.toNativeUtf8();
    try {
      return fn(pathPtr, encodingPtr);
    } finally {
      malloc.free(pathPtr);
  ...
  int entryCount(Pointer<Void> archive) {
    final fn = lib
        .lookupFunction<PfsEntryCountNative, int Function(Pointer<Void>)>(
          'pfs_entry_count',
        );
    return fn(archive);
  }
  ...
  void close(Pointer<Void> archive) {
    final fn = lib.lookupFunction<PfsCloseNative, void Function(Pointer<Void>)>(
      'pfs_close',
    );
    fn(archive);
  }
